...
syn cluster rubyPostfix contains=rubyOperator,rubyMethodOperator,rubyRangeOperator,rubyPostfixKeyword,rubyComma
syn cluster rubyArguments contains=rubyCharacter,rubyString,rubyStringArray,rubySymbol,rubySymbolArray,rubyRegex,rubyCommand,rubyHeredoc,rubyHeredocSkip
syn cluster rubyKeywordArguments contains=rubyHashKey,rubyVariableOrMethod,rubyConstant,rubyKeyword,rubyBlock,rubyDefine,rubyDefineBlock,rubyBlockSkip,rubyDefineLine,rubySelf,rubyNil,rubyBoolean,rubySuper
...
" Delimiters {{{2
syn match rubyDelimiter /\%#=1(/ nextgroup=@rubyKeywordArguments skipwhite skipempty
syn match rubyDelimiter /\%#=1)/ nextgroup=@rubyPostfix skipwhite

syn match rubyDelimiter /\%#=1\[/ nextgroup=@rubyKeywordArguments skipwhite skipempty
syn match rubyDelimiter /\%#=1]/ nextgroup=@rubyPostfix skipwhite

syn match rubyDelimiter /\%#=1{/ nextgroup=rubyBlockParameters,@rubyKeywordArguments skipwhite skipempty
syn match rubyDelimiter /\%#=1}/ nextgroup=@rubyPostfix skipwhite

syn match rubyComma /\%#=1,/ contained nextgroup=@rubyKeywordArguments skipwhite skipempty
...
if get(g:, "ruby_simple_indent") || get(b:, "is_eruby")
  ...
  " This is to handle "endless" definitions (generated by tools/syntax.vim):
